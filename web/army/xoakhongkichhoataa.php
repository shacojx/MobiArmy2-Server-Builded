                    ...
                    <div class="link-more">	
                        <div class="h" align="center">
							...
							<div class="bg_noel"></div>
                              <?php
							require('header.php');
							?> <div class="bg-content">Quá trình xử lý!<br />
<ul>
        <li>
...
$sql = "DELETE FROM `user` WHERE `lock`='1'";

if ($connect->query($sql) === TRUE) {
    //Nếu kết quả kết nối thành công, trở về trang view.
    echo('Xóa Thành công	</br><a href="javascript: history.go(-1)"><u>Trở lại</u></a>'); 
} else { 
    ...
    echo('Lỗi 	</br><a href="javascript: history.go(-1)"><u>Trở lại</u></a>');
}
